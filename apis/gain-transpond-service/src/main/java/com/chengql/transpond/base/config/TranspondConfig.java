package com.hwsafe.transpond.base.config;
...
public class TranspondConfig {
     ...
     * 主机ID
     */
    @Value("${transpond.probehostid}")
    public String probehostid;
    /**
     * 企业ID
     */
    @Value("${transpond.businessinfoid}")
    public String businessinfoid;
