package com.hwsafe.transpond.base.utils;
...
public class AppResponse implements Serializable {
     ...
     * RS_ERROR：500，服务器内部错误 <br/>
     * 
     * @author chengql
     * 
     */
    public enum AppResponseStatus {
        RS_OK(200), RS_FAIL(400), RS_TOKEN_INVALID(401), RS_ERROR(
                500), RS_APPVER_NONUPDATED(2001), RS_APPVER_UPDATED(2000);
