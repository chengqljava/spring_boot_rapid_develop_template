...
public class RedisUtil {
     ...
     *            过期时间,分钟单位
     */
    public void setForTimeCustom(String key, String value, long time,
            TimeUnit type) {
     ...
     * @return 返回差集的数量
     */
    public Long differenceAndStore(String key, Collection<Object> otherKeys,
            String newKey) {
        return redisTemplate.opsForSet().differenceAndStore(newKey, otherKeys,
                newKey);
    }
     ...
     * @return destKey 数量
     */
    public Long unionAndStoreSet(String key, Collection<Object> otherKeys,
            String destKey) {
     ...
     * @return
     */
    public Set<TypedTuple<Object>> rangeWithScores(String key, long start,
            long end) {
     ...
     * @return
     */
    public Set<TypedTuple<Object>> rangeByScoreWithScores(String key,
     ...
     * @return
     */
    public Set<TypedTuple<Object>> reverseRangeWithScores(String key,
            long start, long end) {
     ...
     * @return
     */
    public Set<TypedTuple<Object>> reverseRangeByScoreWithScores(String key,
            double min, double max) {
     ...
     * @return
     */
    public Long unionAndStoreZset(String key, Collection<String> otherKeys,
            String destKey) {
