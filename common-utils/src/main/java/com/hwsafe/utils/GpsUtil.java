...
public class GpsUtil {
    ...
    /**
     * 高德地图 根据用户的起点和终点经纬度计算两点间距离，此距离为相对较短的距离，单位米。
     * 
     ...
     * @return
     */
    public static double calculateLineDistance(Double startLongitude,
            Double startLatitude, Double endLongitude, Double endLatitude) {

        double d1 = 0.01745329251994329D;
        double d2 = startLongitude;
        double d3 = startLatitude;
        double d4 = endLongitude;
        double d5 = endLatitude;
        d2 *= d1;
        d3 *= d1;
        d4 *= d1;
        d5 *= d1;
    ...
    // 113.559089,34.817275 113.563788,34.820129

    // 113.565,34.823155 113.570367,34.825815

    public static void main(String[] args) {
        double v = getLongdistance(113.565, 34.823155, 113.570367, 34.825815);
        System.out.print(v);
    }
