...
public class CustomLicenseManager extends LicenseManager {
    private static Logger logger = LogManager
            .getLogger(CustomLicenseManager.class);
    ...
    protected synchronized LicenseContent install(final byte[] key,
        ...
        final LicenseContent content = (LicenseContent) this
                .load(certificate.getEncoded());
    ...
    protected synchronized LicenseContent verify(final LicenseNotary notary)
        ...
        if (null == key) {
            throw new NoLicenseInstalledException(
    ...
    protected synchronized void validate(final LicenseContent content)
        ...
        if (expectedCheckModel != null && serverCheckModel != null) {
            // 校验IP地址
            /*
             * if(!checkIpAddress(expectedCheckModel.getIpAddress(),
             * serverCheckModel. getIpAddress())){ throw new
             * LicenseContentException("当前服务器的IP没在授权范围内"); }
             */

            // 校验Mac地址
            if (!checkIpAddress(expectedCheckModel.getMacAddress(),
                    serverCheckModel.getMacAddress())) {
            ...
            // 校验CPU序列号
            if (!checkSerial(expectedCheckModel.getCpuSerial(),
                    serverCheckModel.getCpuSerial())) {
    ...
    private Object load(String encoded) {
        ...
        try {
            ...
            decoder = new XMLDecoder(
                    new BufferedInputStream(inputStream, DEFAULT_BUFSIZE), null,
                    null);
     ...
     * @return boolean
     */
    private boolean checkIpAddress(List<String> expectedList,
